...
file_names = ['res-128.txt', 'res-1280.txt', 'res-12800.txt']
num_epoch = 160
num_worker = 4
...
label_list = ['Sync period: 128', 'Sync period: 1280', 'Sync period: 12800']
avg_list = ['Avg 128', 'Avg 1280', 'Avg 12800']
...
plt.savefig(ERROR_GRAPH_OUTPUT_PATH + '/multiples/10/error-128,1280,12800.pdf')
...
plt.savefig(TIME_GRAPH_OUTPUT_PATH + '/multiples/10/time-128,1280,12800.pdf')
...
plt.xlabel("Time")
plt.ylabel("Training error in %")
plt.savefig(ERROR_GRAPH_OUTPUT_PATH + '/multiples/10/error-by-time-128,1280,12800.pdf')

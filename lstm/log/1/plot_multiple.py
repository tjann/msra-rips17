...
file_names = ['res-final2-72.txt', 'res-final2-720.txt']
num_epoch = 50
num_worker = 2

def parse_output_file(file_name):
    with open('../../log/1/' + file_name, 'r') as f:
...
label_list = ['Sync period: 72', 'Sync period: 720']
avg_list = ['Avg 72', 'Avg 720']
...
plt.savefig(GRAPH_OUTPUT_PATH + '/2/error-72,720.pdf')
...
plt.savefig(GRAPH_OUTPUT_PATH + '/2/time-72,720.pdf')
...
plt.xlabel("Time")
plt.ylabel("Training error in %")
plt.savefig(GRAPH_OUTPUT_PATH + '/2/error-by-time-72,720.pdf')

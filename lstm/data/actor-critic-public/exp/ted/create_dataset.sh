...
python2 $LVSR/exp/ted/binarize.py -v 3 -p -e -o -d vocab.de prep/train.de-en.de prep/dev.de-en.de prep/test.de-en.de  
python2 $LVSR/exp/ted/binarize.py -v 3 -p -e -o -d vocab.en prep/train.de-en.en prep/dev.de-en.en prep/test.de-en.en

rm ted.h5

python2 $LVSR/bin/pack_to_hdf5.py ted.h5\
    -s train.de-en.de.pkl dev.de-en.de.pkl test.de-en.de.pkl\
    -t train.de-en.en.pkl dev.de-en.en.pkl test.de-en.en.pkl\
    -n train dev test

python2 $LVSR/exp/ted/add_vocabulary.py ted.h5 sources vocab.de
python2 $LVSR/exp/ted/add_vocabulary.py ted.h5 targets vocab.en
